    ...
    <div class="max-w-md mx-auto mt-10 p-6 bg-slate-800 rounded-lg shadow-md">
      ...
      <form @submit.prevent="handleSubmit" class="space-y-4">
        ...
        <button
          type="submit"
          :disabled="loading"
          class="w-full flex justify-center py-2 px-4 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-blue-600 hover:bg-blue-700 focus:outline-none hover:cursor-pointer focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 disabled:opacity-50 disabled:cursor-not-allowed"
        >
