<template>
  <div
    class="relative flex flex-col w-full md:max-w-5xl mx-auto h-96 overflow-y-auto text-slate-300 bg-slate-800 shadow-md bg-clip-border scrollbar-custom mb-8"
  >
